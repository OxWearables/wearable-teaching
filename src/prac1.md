# Practical 1: Foundamentals of Sensing, Setting up devices
...
In this practical, we'll go through an ethics training and set up your devices to collect data. By the end of the practical, you will be wearing your devices for one day until Practical 2, when you will begin analyzing and visualizing your very own data. 
...
## 1. Ethics Training [optional].

As you may be aware, various ethical issues can stem from research using image-based data. It is important that all researchers involved go through an ethics training to familiarize themselves of related ethical issues. 
...
<!-- Copies are located under the 'reading' folder. -->

* Background Information.

* Kelly, P., Marshall, S.J., Badland, H., Kerr, J., Oliver, M., Doherty, A.R., Foster, C. (2013) An Ethical Framework for automated-wearable cameras in health behaviour research. American Journal of Preventive Medicine 44(3); 314-319

* Parts A & B of “Guidelines for Ethical Visual Research Methods”

* Doherty, A.R., Williamson, W., Hillsdon, M., Hodges, S., Foster, C., Kelly, P. (2013) "Influencing health-related behaviour with wearable cameras: strategies & ethical considerations". Proceedings of SenseCam and Pervasive Imaging Conference, San Diego, USA, November 18-19, 2013
...
You will need to complete the ethical declaration form in order to continue. This can be found at `practicals/prac1/declaration.pdf` 

<!-- You are encouraged to complete the consent form which will allow us to keep the data collected by you in this tutorial if you wish to suspport our future research.  -->

NB. Aiden Doherty is the Principal Investigator.

**Handin:** Ethical Declaration (hard copy of `practicals/prac1/declaration.pdf`) to Hang. 

## 2. About your study. 

The idea of this study is for you to create your own datasest using the wearable camera and acclerometer in order to have a taste of studies of this kind. 

Please take a moment to go through the following background information before you begin collecting data. The text is chiefly about the wearable camera and has been adapted from an information sheet given to actual participants of the CAPTURE-24 study in 2015. 
...
You are free to decide whether or not to take part in this study. You can leave the study at any time by advising the researchers of your decision. There will be no penalty to you for leaving the study at any time. 
...
To set up the camera, you will run a script to ensure the camera has a correct local time and that it does not contain any past data. The time syncing step is important for you to correctly align the acclerometer and camera data. 

The time syncing is based on your Mac's local time - so it is expected to be in UK time and not to deviate too much from the time on Hang's computer. You should also run the script as soon as your camera is plugged in to minimize any time lag. 
...
Now that you've set up the devices, go through the following instructions on how to collect data from these devices. Once you're done, you can go ahead with your day as normal to collect data! 

### Accelerometer

The activity watch is extremely robust and should be worn at all times. Do not worry if this is not a typical time for you (e.g. you are doing more or less physical activity than normal). Please start wearing it as soon as we give it to you. The activity watch has a long battery life (at least a week), so you do not need to charge it. As it is completely silent, you will not be able to tell that it is running.

**Please wear the activity watch on the wrist of the hand that you usually use to write (i.e. your right wrist if you are right-handed)**. Generally this will be most convenient for people since it is typical to wear a watch on the other wrist. However, if for some reason you cannot wear the activity watch on the wrist of the hand that you use to write, then please wear it on the other wrist. The heart-beat symbol should be on the inside of your wrist (i.e. facing towards you).

The activity watch is robust and water-proof, and has been designed to be worn when working or sleeping, having a bath or shower, or playing all types of sport (including swimming). Extremes of temperature may damage the battery so it should be taken off while you have a sauna.
...
* All images will be treated with the strictest confidence and participants will be given the option to review and delete any or all images before analysis
